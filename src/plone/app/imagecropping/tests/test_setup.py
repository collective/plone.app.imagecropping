...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        if get_installer is None:
            is_installed = self.installer.isProductInstalled("plone.app.imagecropping")
        else:
    ...
    def test_browserlayer(self):
        ...
        from plone.app.imagecropping.interfaces import IPloneAppImagecroppingLayer
    ...
    def test_controlpanel(self):
        ...
        self.assertIn(
            "imagecropping.settings", actions, "control panel was not removed"
        )
...
class TestUninstall(unittest.TestCase):
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(IPloneAppImagecroppingLayer, utils.registered_layers())
